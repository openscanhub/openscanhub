...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field analyzers on 'Result'
        db.create_table(u'waiving_result_analyzers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('result', models.ForeignKey(orm[u'waiving.result'], null=False)),
            ('analyzerversion', models.ForeignKey(orm[u'scan.analyzerversion'], null=False))
        ))
        db.create_unique(u'waiving_result_analyzers', ['result_id', 'analyzerversion_id'])


    def backwards(self, orm):
        # Removing M2M table for field analyzers on 'Result'
        db.delete_table('waiving_result_analyzers')
