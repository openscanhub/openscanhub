...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WaivingLog'
        db.create_table('waiving_waivinglog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('state', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('waiver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['waiving.Waiver'])),
        ))
        db.send_create_signal('waiving', ['WaivingLog'])

        # Adding field 'Waiver.is_deleted'
        db.add_column('waiving_waiver', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CheckerGroup.name'
        db.alter_column('waiving_checkergroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
        # Adding field 'Defect.cwe'
        db.add_column('waiving_defect', 'cwe',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Checker.severity'
        # db.add_column('waiving_checker', 'severity',
        #               self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
        #               keep_default=False)


        # Changing field 'Checker.name'
        db.alter_column('waiving_checker', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):
        # Deleting model 'WaivingLog'
        db.delete_table('waiving_waivinglog')

        # Deleting field 'Waiver.is_deleted'
        db.delete_column('waiving_waiver', 'is_deleted')


        # Changing field 'CheckerGroup.name'
        db.alter_column('waiving_checkergroup', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
        # Deleting field 'Defect.cwe'
        db.delete_column('waiving_defect', 'cwe')

        # Deleting field 'Checker.severity'
        # db.delete_column('waiving_checker', 'severity')


        # Changing field 'Checker.name'
        db.alter_column('waiving_checker', 'name', self.gf('django.db.models.fields.CharField')(max_length=32))
