...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ETMapping.comment'
        db.add_column('scan_etmapping', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ETMapping.comment'
        db.delete_column('scan_etmapping', 'comment')
    ...
    models = {
        ...
        'scan.etmapping': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
        ...
        'scan.taskextension': {
            ...
            'task': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['hub.Task']", 'unique': 'True'})
        },
        'waiving.result': {
