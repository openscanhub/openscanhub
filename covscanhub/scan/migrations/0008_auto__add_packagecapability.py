...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PackageCapability'
        db.create_table(u'scan_packagecapability', (
            ...
            ('is_capable', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'scan', ['PackageCapability'])


    def backwards(self, orm):
        # Deleting model 'PackageCapability'
        db.delete_table(u'scan_packagecapability')
